(() => {
  const ar = {
    ...
    "Signature Service":"الخدمة المميزة","Premium Microblading":"المايكروبليدنج الفاخر","Our most exclusive brow experience":"تجربتنا الأكثر تميزاً للحواجب","An elevated brow experience with extra precision, customization and attention to detail. Includes a more personalized brow design, refined mapping, premium pigment selection and enhanced finishing for a truly luxurious result.":"تجربة حواجب راقية بمزيد من الدقة والتخصيص والاهتمام بالتفاصيل. تشمل تصميماً أكثر تخصيصاً للحواجب، ورسماً دقيقاً، واختيار صبغات فاخرة، ولمسات نهائية محسّنة لنتيجة فاخرة حقاً.","For clients who want an extra level of detail and exclusivity.":"للعميلات اللواتي يرغبن في مستوى إضافي من التفاصيل والخصوصية.","Book Premium":"احجزي الخدمة الفاخرة",
